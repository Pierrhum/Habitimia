...
public class RecyclerItemDailyTouchHelper extends ItemTouchHelper.SimpleCallback {

    private DailyAdapter adapter;

    public RecyclerItemDailyTouchHelper(DailyAdapter adapter) {
    ...
    public void onSwiped(@NonNull final RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (direction == ItemTouchHelper.LEFT) {
            ...
            builder.setMessage("Are you sure you want to delete this daily?");
...
//                                            + adapter.getItem(position).getDifficulty().ordinal() + " HP!");
            ...
            dialog.show();
                ...
                CreateDailyFragment newFragment = new CreateDailyFragment();
                Bundle args = new Bundle();
                args.putSerializable("daily",  adapter.getItem(position));
